...
<head>
  <meta charset="utf-8" />
  <title>Cancellation & Refund Policy of Mihu Systems</title>
    ...
    <div class="contact-inner area-padding">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <p>
            Logic ERP will be providing feature and function as describe in Logic ERP website under Logic Business
            product. If license will be installed at client system/premises or database install in Cloud server after
            that
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="contact-icon text-center">
              <div class="single-icon">
                ...
                <p>
                  Call: +91 7666529550 <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+91 7972247649<br />
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="contact-icon text-center">
              <div class="single-icon">
                ...
                <p>
                  Location: Max Parlour, 4th, 401, Khopade Empire, S. No. 8/1, Khopade Nagar, Gujarwadi Road, Katraj,
                  Pune, Pune,<br />
