...
<head>
    ...
    <title>Fuel Station | Orders</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <?php $this->load->view('components/order'); ?>
            <!-- /.content -->
        </div>
        <!-- /.content-wrapper -->
        ...
        <script>
            ...
            function viewOrder(orders, vch_no, status) {
                ...
                if (status == 1) {
                    document.getElementById('mark-delever-btn').style.display = 'none';
                } else {
                    document.getElementById('mark-delever-btn').style.display = 'block';
                    document.getElementById('vch_num').setAttribute('value', vch_no);
                }
