      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="fa fa-chevron-right"></i> <a href="tc.php">Terms & Conditions</a></li>
              <li><i class="fa fa-chevron-right"></i> <a href="privacy-policy.php">Privacy Policies</a></li>
              <li><i class="fa fa-chevron-right"></i> <a href="ship-policy.php">Shipping & Delivery Policy</a></li>
              <li><i class="fa fa-chevron-right"></i> <a href="rc.php">Refund & Cancellation</a></li>
            </ul>
          </div>
