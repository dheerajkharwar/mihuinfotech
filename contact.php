...
<head>
  ...
  <link rel="stylesheet" href="<?= $base ?>css/contactform.css" />
</head>
...
<body data-spy="scroll" data-target="#navbar-example">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="fa fa-chevron-right"></i> <a href="<?= $base ?>tc.php">Terms & Conditions</a></li>
              <li><i class="fa fa-chevron-right"></i> <a href="<?= $base ?>privacy-policy.php">Privacy Policies</a></li>
              <li><i class="fa fa-chevron-right"></i> <a href="<?= $base ?>ship-policy.php">Shipping & Delivery Policy</a></li>
              <li><i class="fa fa-chevron-right"></i> <a href="<?= $base ?>rc.php">Refund & Cancellation</a></li>
            </ul>
          </div>
  ...
  <script src="<?= $base ?>js/contactform.js"></script>
