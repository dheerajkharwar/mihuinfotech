          ...
          <div class="slider-content text-center">
            <div class="header-bottom">
              <div class="layer2 wow zoomIn" data-wow-duration="1s" data-wow-delay=".4s">
                <h1 class="title1">Your Questions, Our Expertise</h1>
              </div>
              <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                <h2 class="title3">Contact Us Today</h2>
              </div>
            </div>
          </div>
        </div>
...
// }services.php">Our services</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="fa fa-chevron-right"></i> <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }tc.php">Terms & Conditions</a></li>
              <li><i class="fa fa-chevron-right"></i> <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }privacy-policy.php">Privacy Policies</a></li>
              <li><i class="fa fa-chevron-right"></i> <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }ship-policy.php">Shipping & Delivery Policy</a></li>
              <li><i class="fa fa-chevron-right"></i> <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }rc.php">Refund & Cancellation</a></li>
            </ul>
          </div>
