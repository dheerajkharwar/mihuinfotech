...
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }https://wa.me/917666529550?text=Hi"><img
                                        src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/whatsapp-logo.png" alt="whatsapp" /></a>
                            </div>
                    ...
                    <div class="slider-content text-center">
                        <div class="header-bottom">
                            <div class="layer2 wow zoomIn" data-wow-duration="1s" data-wow-delay=".4s">
                                <h1 class="title1">Navigating Innovation, Embracing Trust</h1>
                            </div>
                            <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                                <h2 class="title3">Guided by Trustworthy Terms</h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="contact" class="contact-area">
        <div class="contact-inner area-padding">
            ...
            <div class="container">
                ...
                <div class="row">
                    <p>
                        The Website Owner, including subsidiaries and affiliates (“Website” or “Website Owner” or “we”
                        or “us” or “our”) provides the information contained on the website or any of the pages
                        comprising the website (“website”) to visitors (“visitors”) (cumulatively referred to as “you”
                        or “your” hereinafter) subject to the terms and conditions set out in these website terms and
                        conditions, the privacy policy and any other relevant terms and conditions, policies and notices
                    ...
                    <p>
                        ...
                        privacy policy govern Mihu Systems''s relationship with you in relation to this website.
                    </p>
                    <p>
                        The term 'Mihu Systems' or 'us' or 'we' refers to the owner of the website whose
                        registered/operational office is Max Parlour, 4th, 401, Khopade Empire, S. No. 8/1, Khopade
                        Nagar, Gujarwadi Road, Katraj, Pune, Pune, Maharashtra, 411046. The term 'you' refers to the
                        user or
                    ...
                    <ol style="list-style-type: circle;">
                        ...
                        <li>From time to time this website may also include links to other websites. These links are
                            provided for your convenience to provide further information.</li>
                        <li>You may not create a link to this website from another website or document without Mihu
                            Infotech’s prior written consent.</li>
                    ...
                    <h3>Subscription Of Application</h3>
                    <p>
                        Subscription of Application is Valid for period for which subscription availed afterwards issued
                        the
                        key/Order name of company/firm and Subsequent years charge payment is mandatory for continue to
                        run
                        the
                        application. Logic Business Applications features, functions and Pricing are shown in our
                        website
                        for ready
                        reference. Please visit <a
                            href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }http://www.logicerp.com/Solutions/LogicDesktop">http://www.logicerp.com/Solutions/LogicDesktop</a>
                        &
                        <a
                            href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }http://www.logicerp.com/Solutions/LogicCloud">http://www.logicerp.com/Solutions/LogicCloud</a>
                        for more detail.
                    </p>
                    <h3>Implementation Clause</h3>
                    <p>
                        Mode of implementation for Logic Business Application is online and support, software up
                        gradation of
                        Generic is free, and Customers support team will be handled through online and telephonically by
                        Mihu
                        Team.
                    </p>
                    <h3>License amount is non-refundable</h3>
                    <p>
                        Logic ERP will be providing feature and function as describe in Logic ERP website under Logic
                        Business
                        product. If license will be installed at client system/premises or database install in Cloud
                        server after that
                        paid amount will not refundable. Client is solely responsible to ensure the feature and function
                        as getting
...
// }http://www.logicerp.com/Solutions/LogicCloud">http://www.logicerp.com/Solutions/LogicCloud</a>
                    ...
                    <h3>Visit Charge</h3>
                    <p>
                        Visit charge is applicable as per mentioned above within available location as per acceptance by
                        MIHU Team.
                    </p>
                </div>
                <div class="row">
...
// }t&c.php">Terms & Conditions</a></li>
                            <li><i class="fa fa-chevron-right"></i> <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }privacy-policy.php">Privacy Policies</a>
                            </li>
                            <li><i class="fa fa-chevron-right"></i><a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
...
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }https://www.facebook.com/profile.php?id=100094703150978"
...
// }https://www.instagram.com/mihu_infotech/" target="_blank"><i
                                    ...
                                    <li>
                                        <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }https://www.youtube.com/@LOGICERP" target="_blank"><i
