  ...
  <div id="services" class="services-area area-padding" style="margin-top: 0; padding-top: 20px">
    <div class="container">
      ...
      <div id="logic-erp" class="row text-center border1">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
            <h3 style="margin-top: 10px">
              <a class="services-icon" href="<?= $base ?>https://www.logicerp.com">
                <img style="width: 400px" src="<?= $base ?>img/logic-logo.png" alt="Logic ERP" />
              </a>
            </h3>
          </div>
        </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="single-team-member border1">
                      <h4 style="
                            ...
                            color: #000;
                          ">
                        <img src="<?= $base ?>img/retail.png" alt="retail" width="50px" /><br />Retail
                      </h4>
                      <ul>
                        <li>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="single-team-member border1">
                      <h4 style="
                            ...
                            color: #000;
                          ">
                        <img src="<?= $base ?>img/dst.png" alt="distribution" width="50px" /><br />Distribution
                      </h4>
                      <ul>
                        <li>
                          <i class="fa fa-check"></i> Apparel & Footwear
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="single-team-member border1">
                      <h4 style="
                            ...
                            color: #000;
                          ">
                        <img src="<?= $base ?>img/mfg.png" alt="manufacturing" width="50px" /><br />Manufacturing
                      </h4>
                      <ul>
                        <li>
                          <i class="fa fa-check"></i> Apparel & Footwear
        ...
        <div class="text-center">
          <a style="margin-top: 20px; margin-bottom: 20px" class="btn btn-primary" href="<?= $base ?>https://www.logicerp.com">Click
            Here To View More >>
          </a>
        </div>
      </div>
      ...
      <div id="digital-marketing" class="row text-center border1">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
            <h3 style="margin-top: 20px; font-weight: 600">
              <img src="<?= $base ?>img/digital.png" alt="digital marketing icon" /><br />Digital Marketing
            </h3>
          </div>
        </div>
        <p>
      ...
      <div id="photography" class="row text-center border1">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
            <h3 style="margin-top: 20px; font-weight: 600">
              <img src="<?= $base ?>img/phtotgraphy.png" alt="photography icon" /><br />Photography
            </h3>
          </div>
        </div>
        <p>
