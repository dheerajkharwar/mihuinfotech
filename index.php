...
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/slider/slider1.jpg" alt="" title="#slider-direction-1" />
                <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/slider/slider2.jpg" alt="" title="#slider-direction-2" />
                <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/slider/slider3.jpg" alt="" title="#slider-direction-3" />
            </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="slider-content">
                                ...
                                <div style="margin-top: 25px" class="layer-1-3 hidden-xs wow slideInUp"
                                    ...
                                    <a class="ready-btn right-btn page-scroll" href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }services.php">See Services</a>
                                    <a class="ready-btn page-scroll" href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }about.php">View More</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="text-center">
                    <a style="margin-top: 20px" class="btn btn-primary" href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }about.php">View More >>
                    </a>
                </div>
                        ...
                        <div class="about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    <a class="services-icon" href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }services.php#logic-erp">
                                        <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/logic-logo-icon.png" alt="Logic ERP" />
                                    </a>
                        ...
                        <div class="about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    <a class="services-icon" href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }services.php#web-dev">
                                        <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/web.png" alt="web icon" />
                                    </a>
                        ...
                        <div class="about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    <a class="services-icon" href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }services.php#digital-marketing">
                                        <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/digital.png" alt="digital marketing icon" />
                                    </a>
                        ...
                        <div class="about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    <a class="services-icon" href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }services.php#photography">
                                        <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/phtotgraphy.png" alt="photography icon" />
                                    </a>
                                    <h4>Photography</h4>
                                    <p>
...
// }#check1">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="check-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }#check2">
...
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }#p-view-1" role="tab" data-toggle="tab">Project</a>
                            </li>
                            <li>
                                <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }#p-view-2" role="tab" data-toggle="tab">Planning</a>
                            </li>
                            <li>
                                <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }#p-view-3" role="tab" data-toggle="tab">Success</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 mb-5">
                        <div class="single-team-member border1">
                            <div class="team-img">
                                <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/1.jpg" class="venobox" data-gall="myGallery">
                                    <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/1.jpg" alt="Mr. Omprakash Kharawanshi" />
                                </a>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 mb-5">
                        <div class="single-team-member border1">
                            <div class="team-img">
                                <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/2.jpg" class="venobox" data-gall="myGallery">
                                    <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/2.jpg" alt="Mrs. Kanchan Kharawanshi" />
                                </a>
                                <div class="team-social-icon text-center">
                                    <ul>
                                        <li>
...
// }#">
                    ...
                    <!--            <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/3.jpeg" class="venobox" data-gall="myGallery">-->
                    <!--                <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/3.jpeg" alt="R.R. Patra" />-->
                    <!--            </a>-->
                    <!--            <div class="team-social-icon text-center">-->
                    <!--                <ul>-->
                    <!--                    <li>-->
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 mb-5">
                        <div class="single-team-member border1">
                            <div class="team-img">
                                <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/4.jpeg" class="venobox" data-gall="myGallery">
                                    <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/4.jpeg" alt="Dheeraj Kharwar" />
                                </a>
                                <div class="team-social-icon text-center">
                                    <ul>
                                        <li>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 mb-5">
                        <div class="single-team-member border1">
                            <div class="team-img">
                                <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/5.jpg" class="venobox" data-gall="myGallery">
                                    <img src="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }img/team/5.jpg" alt="GST Practitioner & Finance Head" />
                                </a>
                                <div class="team-social-icon text-center">
                                    <ul>
                                        <li>
...
// }img/slider/slider2.jpg" alt="" />
            ...
            <div class="work-right-text text-center">
                ...
                <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }contact.php" class="ready-btn">Contact us</a>
            </div>
        </div>
    </div>
    <!-- End reviews Area -->
...
// }img/portfolio/logic/4.1.jpg">
                ...
                <div class="text-center">
                    <a class="btn btn-primary" href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }portfolio.php">View More >> </a>
                    <br />
                    <br />
                </div>
            </div>
...
// }https://www.facebook.com/profile.php?id=100094703150978"
                                    ...
                                    <li>
                                        <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }https://www.linkedin.com/company/mihu-Systems/" target="_blank"><i
                                                class="fa fa-linkedin"></i></a>
                                    </li>
                                    <li>
                                        <a href="// if (!isset($_GET['q'])) {
//   header('Location: ' . $currentURL . '?q=' . generateRandomString(64));
// }https://www.instagram.com/mihu_Systems/" target="_blank"><i
